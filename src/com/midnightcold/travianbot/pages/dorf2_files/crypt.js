...
var j=this.instanceOf=function(v,t){
    if(v==null){
        return false
        }
...
f.prototype.extend=function(t,u){
    this[t]=u
    }.overloadSetter();
f.prototype.implement=function(t,u){
    this.prototype[t]=u
    }.overloadSetter();
var n=Array.prototype.slice;
f.from=function(t){
    return(o(t)=="function")?t:function(){
        return t
        }
    };
...
Array.from=function(t){
    if(t==null){
        ...
        return(a.isEnumerable(t)&&typeof t!="string")?(o(t)=="array")?t:n.call(t):[t]
    };
...
a.isEnumerable=function(t){
    return(t!=null&&typeof t.length=="number"&&e.call(t)!="[object Function]")
    };
...
if(w==null||!w.$protected){
    ...
    m.call(this,u,function(z){
        return y.apply(z,n.call(arguments,1))
        })
    }
};
...
a.implement({
    ...
    alias:function(t,u){
        b.call(this,t,this.prototype[u])
        }.overloadSetter(),
    mirror:function(t){
        s(this).push(t);
        return this
...
Number.extend("random",function(u,t){
    return Math.floor(Math.random()*(t-u+1)+u)
    });
var g=Object.prototype.hasOwnProperty;
Object.extend("forEach",function(t,v,w){
    for(var u in t){
        if(g.call(t,u)){
            v.call(w,t[u],u,t)
            }
...
(function(){
    var k=this.document;
    var g=k.window=this;
    var a=navigator.userAgent.toLowerCase(),b=navigator.platform.toLowerCase(),h=a.match(/(opera|ie|firefox|chrome|version)[\s\/:]([\w\d\.]+)?.*?(safari|version[\s\/:]([\w\d\.]+)|$)/)||[null,"unknown",0],d=h[1]=="ie"&&k.documentMode;
    var o=this.Browser={
...
try{
    ...
    ["pop","push","reverse","shift","sort","splice","unshift","concat","join","slice"].each(function(e){
        var q=l[e];
        Array[e]=function(r){
            return q.apply(Array.from(r),n.call(arguments,1))
            }
        })
}
})();
(function(){
    ...
    if(j=="click"||j=="dblclick"||j=="contextmenu"||j=="DOMMouseScroll"||j.indexOf("mouse")==0){
        var k=g.document;
        k=(!k.compatMode||k.compatMode=="CSS1Compat")?k.html:k.body;
        this.page={
            x:(c.pageX!=null)?c.pageX:c.clientX+k.scrollLeft,
            y:(c.pageY!=null)?c.pageY:c.clientY+k.scrollTop
            };
        this.client={
        ...
        if(j=="DOMMouseScroll"||j=="mousewheel"){
            this.wheel=(c.wheelDelta)?c.wheelDelta/120:-(c.detail||0)/3
            }
            this.rightClick=(c.which==3||c.button==2);
        if(j=="mouseover"||j=="mouseout"){
            var l=c.relatedTarget||c[(j=="mouseover"?"from":"to")+"Element"];
    ...
    if(j.indexOf("touch")==0||j.indexOf("gesture")==0){
...
var c=function(){
    if(!this.$caller){
        ...
        var g=this.$caller.$name,h=this.$caller.$owner.parent,j=(h)?h.prototype[g]:null;
    if(!j){
...
var b=function(g,h,k){
    if(k.$origin){
        k=k.$origin
        }
        var j=function(){
        if(k.$protected&&this.$caller==null){
...
var f=function(h,j,g){
    if(a.Mutators.hasOwnProperty(h)){
        j=a.Mutators[h].call(this,j);
        if(j==null){
            return this
            }
        }
    ...
    if(j.$hidden){
        ...
        this.prototype[h]=(g)?j:b(this,h,j)
    }else{
    Object.merge(this.prototype,h,j)
    }
    return this
};
...
a.Mutators={
    ...
    Implements:function(g){
        Array.from(g).each(function(k){
            var h=new k;
            for(var j in h){
                f.call(this,j,h[j],true)
                }
            },this)
    }
}
...
(function(){
    ...
    o=-1;
    while(s!=(s=s.replace(k,b))){}
    l.length=l.expressions.length;
    return q[l.raw]=(g)?h(l):l
    };
...
var f=function(q){
    return q.replace(/[-[\]{}()*+?.\\^$|,#\s]/g,function(r){
        return"\\"+r
        })
    };
    
var k=new RegExp("^(?:\\s*(,)\\s*|\\s*(<combinator>+)\\s*|(\\s+)|(<unicode>+|\\*)|\\#(<unicode>+)|\\.(<unicode>+)|\\[\\s*(<unicode1>+)(?:\\s*([*^$!~|]?=)(?:\\s*(?:([\"']?)(.*?)\\9)))?\\s*\\](?!\\])|(:+)(<unicode>+)(?:\\((?:(?:([\"'])([^\\13]*)\\13)|((?:\\([^)]+\\)|[^()]*)+))\\))?)".replace(/<combinator>/,"["+f(">+~`!@$%^&={}\\;</")+"]").replace(/<unicode>/g,"(?:[\\w\\u00a1-\\uFFFF-]|\\\\[^\\s0-9a-f])").replace(/<unicode1>/g,"(?:[:\\w\\u00a1-\\uFFFF-]|\\\\[^\\s0-9a-f])"));
function b(z,u,F,B,t,E,s,D,C,A,w,H,I,x,r,y){
    if(u||o===-1){
        l.expressions[++o]=[];
        m=-1;
        if(u){
...
if(t){
    ...
    if(E){
        ...
        if(s){
            ...
            q.classes.push({
                value:s,
                regexp:new RegExp("(^|\\s)"+f(s)+"(\\s|$)")
                })
            }else{
            if(I){
                y=y||r;
                y=y?y.replace(n,""):null;
                if(!q.pseudos){
                    q.pseudos=[]
                    }
                    q.pseudos.push({
...
(function(){
    var l={},n={},d=Object.prototype.toString;
    l.isNativeCode=function(c){
...
this.document=y;
var C=y.documentElement,q=this.getUIDXML(C),u=n[q],t;
    if(u){
    for(t in u){
        this[t]=u[t]
        }
...
u.isXMLDocument=this.isXML(y);
    ...
    var o=y.body||y.getElementsByTagName("body")[0]||C;
    o.appendChild(c);
    try{
    c.innerHTML='<a id="'+x+'"></a>';
    ...
    u.brokenStarGEBTN=w||s;
    try{
        c.innerHTML='<a name="'+x+'"></a><b id="'+x+'"></b>';
    ...
    u.nativeMatchesSelector=C.matchesSelector||C.mozMatchesSelector||C.webkitMatchesSelector;
    if(u.nativeMatchesSelector){
    try{
        u.nativeMatchesSelector.call(C,":slick");
...
try{
    ...
    o.removeChild(c);
c=z=o=null;
u.getAttribute=(u.isHTMLDocument&&v)?function(I,G){
    var J=this.attributeGetters[G];
    if(J){
        return J.call(I)
        }
    ...
    var I=this.attributeGetters[G];
    return(I)?I.call(H):H.getAttribute(G)
    };
    
u.hasAttribute=(C&&this.isNativeCode(C.hasAttribute))?function(H,G){
    return H.hasAttribute(G)
    }:function(H,G){
    H=H.getAttributeNode(G);
    return !!(H&&(H.specified||H.nodeValue))
    };
    
var F=C&&this.isNativeCode(C.contains),D=y&&this.isNativeCode(y.contains);
u.contains=(F&&D)?function(G,H){
    return G.contains(H)
    }:(F&&!D)?function(G,H){
    return G===H||((G===y)?y.documentElement:G).contains(H)
    }:(C&&C.compareDocumentPosition)?function(G,H){
    return G===H||!!(G.compareDocumentPosition(H)&16)
    }:function(G,H){
    if(H){
        do{
            if(H===G){
...
l.matchNTH=/^([+-]?\d*)?([a-z]+)?([+-]\d+)?$/;
l.parseNTHArgument=function(s){
    var q=s.match(this.matchNTH);
    if(!q){
        return false
        }
        var r=q[2]||false;
...
l.createNTHPseudo=function(r,o,c,q){
    return function(u,s){
        var w=this.getUID(u);
        if(!this[c][w]){
            var C=u.parentNode;
...
l.pushArray=function(r,c,t,q,o,s){
    if(this.matchSelector(r,c,t,q,o,s)){
        this.found.push(r)
        }
    };

l.pushUID=function(s,c,u,r,o,t){
    var q=this.getUID(s);
    if(!this.uniques[q]&&this.matchSelector(s,c,u,r,o,t)){
        this.uniques[q]=true;
        this.found.push(s)
        }
    };

l.matchNode=function(o,q){
    if(this.isHTMLDocument&&this.nativeMatchesSelector){
        try{
            return this.nativeMatchesSelector.call(o,q.replace(/\[([^=]+)=\s*([^'"\]]+?)\s*\]/g,'[$1="$2"]'))
            }catch(w){}
    }
    var v=this.Slick.parse(q);
if(!v){
    return true
    }
    var t=v.expressions,u=0,s;
for(s=0;(currentExpression=t[s]);s++){
    if(currentExpression.length==1){
        var r=currentExpression[0];
        if(this.matchSelector(o,(this.isXMLDocument)?r.tag:r.tag.toUpperCase(),r.id,r.classes,r.attributes,r.pseudos)){
            return true
            }
            u++
    }
...
l.matchSelector=function(q,x,c,r,s,u){
    if(x){
        var v=(this.isXMLDocument)?q.nodeName:q.nodeName.toUpperCase();
        if(x=="*"){
            if(v<"@"){
                return false
                }
...
if(s){
    for(t=s.length;t--;){
        o=s[t];
        if(o.operator?!o.test(this.getAttribute(q,o.key)):!this.hasAttribute(q,o.key)){
            return false
            }
        }
    }
if(u){
    for(t=u.length;t--;){
        o=u[t];
        if(!this.matchPseudo(q,o.key,o.value)){
            return false
            }
        }
    }
...
var k={
    " ":function(s,y,o,t,u,w,r){
        var v,x,q;
        if(this.isHTMLDocument){
            getById:if(o){
                x=this.document.getElementById(o);
                if((!x&&s.all)||(this.idGetsName&&x&&x.getAttributeNode("id").nodeValue!=o)){
                    q=s.all[o];
                    if(!q){
                        return
                    }
            ...
            if(this.document!==s&&!this.contains(s,x)){
                return
            }
        }
        this.push(x,y,null,t,u,w);
    ...
    getByClass:if(t&&s.getElementsByClassName&&!this.brokenGEBCN){
    q=s.getElementsByClassName(r.join(" "));
    if(!(q&&q.length)){
        break getByClass
    }
    for(v=0;x=q[v++];){
        this.push(x,y,o,null,u,w)
        }
        return
}
}
getByTag:{
    q=s.getElementsByTagName(y);
    if(!(q&&q.length)){
        break getByTag
    }
...
"^":function(r,c,t,q,o,s){
    ...
    if(r){
        if(r.nodeType==1){
            ...
            this["combinator:+"](r,c,t,q,o,s)
            }
        }
},
"~":function(s,c,u,r,o,t){
    while((s=s.nextSibling)){
        if(s.nodeType!=1){
            continue
        }
        var q=this.getUID(s);
        if(this.bitUniques[q]){
            break
        }
        this.bitUniques[q]=true;
        this.push(s,c,u,r,o,t)
        }
    },
"++":function(r,c,t,q,o,s){
    this["combinator:+"](r,c,t,q,o,s);
...
"nth-child":l.createNTHPseudo("firstChild","nextSibling","posNTH"),
"nth-last-child":l.createNTHPseudo("lastChild","previousSibling","posNTHLast"),
"nth-of-type":l.createNTHPseudo("firstChild","nextSibling","posNTHType",true),
"nth-last-of-type":l.createNTHPseudo("lastChild","previousSibling","posNTHTypeLast",true),
index:function(o,c){
...
e.version="1.1.7";
e.search=function(o,q,c){
    return l.search(o,q,c)
    };
    
e.find=function(c,o){
    return l.search(c,o,null,true)
    };
...
e.defineAttributeGetter=function(c,o){
    l.attributeGetters[c]=o;
    return this
    };
    
e.lookupAttributeGetter=function(c){
    return l.attributeGetters[c]
    };
    
e.definePseudo=function(c,o){
    l["pseudo:"+c]=function(r,q){
        return o.call(r,q)
        };
...
(function(){
    var f=Array.prototype.splice,a={
        "0":0,
        "1":1,
        length:2
    };
...
(function(){
    ...
    Document.implement({
        ...
        id:(function(){
            var e={
                string:function(G,F,l){
                    G=Slick.find(l,"#"+G.replace(/(\W)/g,"\\$1"));
                ...
                element:function(F,G){
                    ...
                    if(!G&&!F.$family&&!(/^(?:object|embed)$/i).test(F.tagName)){
                        var l=F.fireEvent;
                        F._fireEvent=function(H,I){
                            return l(H,I)
                            };
                            
                        Object.append(F,Element.Prototype)
                        }
                        return F
                    },
                object:function(F,G,l){
                    if(F.toElement){
                        return e.element(F.toElement(l),G)
                        }
                        return null
                    }
                };
        ...
        return function(F,H,G){
            if(F&&F.$family&&F.uniqueNumber){
                return F
                }
                var l=typeOf(F);
            return(e[l])?e[l](F,H,G||document):null
            }
        })()
    });
if(window.$==null){
...
Object.forEach({
    ...
    Element.implement(l,function(F){
        return this.getElement(t(F,e))
        })
    });
Object.forEach({
    getAllNext:"~",
...
after:function(l,e){
    var F=e.parentNode;
    if(F){
        F.insertBefore(l,e.nextSibling)
        }
    },
bottom:function(l,e){
    e.appendChild(l)
...
m.html="innerHTML";
m.text=(document.createElement("div").textContent==null)?"innerText":"textContent";
Object.forEach(m,function(l,e){
    d[e]=function(F,G){
        F[l]=G
        };
...
var z=["compact","nowrap","ismap","declare","noshade","checked","disabled","readOnly","multiple","selected","noresize","defer","defaultChecked","autofocus","controls","autoplay","loop"];
var h={};

Array.forEach(z,function(e){
    var l=e.toLowerCase();
    h[l]=e;
    d[l]=function(F,G){
        F[e]=!!G
...
Element.implement({
    setProperty:function(l,F){
        var G=d[l.toLowerCase()];
        if(G){
            G(this,F)
            }else{
            if(s){
...
getProperty:function(H){
    var F=k[H.toLowerCase()];
    if(F){
        return F(this)
        }
        if(s){
        var l=this.getAttributeNode(H),G=this.retrieve("$attributeWhiteList",{});
        if(!l){
            return null
            }
            if(l.expando&&!G[H]){
            var I=this.outerHTML;
            if(I.substr(0,I.search(/\/?['"]?>(?![^<]*<['"])/)).indexOf(H)<0){
                return null
                }
                G[H]=true
            }
        }
    var e=Slick.getAttribute(this,H);
return(!e&&!Slick.hasAttribute(this,H))?null:e
},
...
set:function(F,l){
    var e=Element.Properties[F];
    (e&&e.set)?e.set.call(this,l):this.setProperty(F,l)
    }.overloadSetter(),
get:function(l){
...
adopt:function(){
    var G=this,e,I=Array.flatten(arguments),H=I.length;
    if(H>1){
        G=e=document.createDocumentFragment()
        }
        for(var F=0;F<H;F++){
        var l=document.id(I[F],true);
        if(l){
            G.appendChild(l)
            }
        }
...
grab:function(l,e){
    y[e||"bottom"](document.id(l,true),this);
    return this
    },
inject:function(l,e){
    y[e||"bottom"](this,document.id(l,true));
    return this
    },
replaces:function(e){
...
toQueryString:function(){
    var e=[];
    this.getElements("input, select, textarea").each(function(F){
        var l=F.type;
        if(!F.name||F.disabled||l=="submit"||l=="reset"||l=="file"||l=="image"){
            return
        }
        var G=(F.get("tag")=="select")?F.getSelected().map(function(H){
            return document.id(H).get("value")
            }):((l=="radio"||l=="checkbox")&&!F.checked)?null:F.get("value");
        Array.from(G).each(function(H){
            if(typeof H!="undefined"){
                e.push(encodeURIComponent(F.name)+"="+encodeURIComponent(H))
                }
            })
    });
return e.join("&")
...
Element.implement({
    destroy:function(){
        var e=x(this).getElementsByTagName("*");
        Array.each(e,x);
    ...
    clone:function(I,G){
        I=I!==false;
        var N=this.cloneNode(I),F=[N],H=[this],L;
        if(I){
            F.append(Array.from(N.getElementsByTagName("*")));
            ...
            if(!G){
                ...
                J.clearAttributes();
                J.mergeAttributes(M);
                J.removeAttribute("uniqueNumber");
                if(J.options){
                    var Q=J.options,e=M.options;
                    for(var K=Q.length;K--;){
                        Q[K].selected=e[K].selected
                        }
                    }
                }
        var l=E[M.tagName.toLowerCase()];
        if(l&&M[l]){
            J[l]=M[l]
            }
        }
    if(Browser.ie){
    var O=N.getElementsByTagName("object"),P=this.getElementsByTagName("object");
    for(L=O.length;L--;){
        O[L].outerHTML=P[L].outerHTML
        }
    }
...
[Element,Window,Document].invoke("implement",{
    addListener:function(G,F){
        if(G=="unload"){
            var e=F,l=this;
            F=function(){
                l.removeListener("unload",F);
                e()
                }
            }else{
        ...
        this.addEventListener(G,F,!!arguments[2])
        }else{
        this.attachEvent("on"+G,F)
        }
        return this
    },
...
retrieve:function(l,e){
    var G=D(Slick.uidOf(this)),F=G[l];
    if(e!=null&&F==null){
        F=G[l]=e
        }
...
store:function(l,e){
    var F=D(Slick.uidOf(this));
    F[l]=e;
    return this
    },
eliminate:function(e){
    var l=D(Slick.uidOf(this));
    delete l[e];
    return this
    }
});
...
v.innerHTML="<nav></nav>";
var a=(v.childNodes.length==1);
if(!a){
    var u="abbr article aside audio canvas datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video".split(" "),b=document.createDocumentFragment(),w=u.length;
    while(w--){
        b.createElement(u[w])
        }
    }
...
var c=document.createElement("tr"),q="<td></td>";
c.innerHTML=q;
var A=(c.innerHTML==q);
c=null;
if(!g||!A||!a){
    Element.Properties.html.set=(function(l){
        ...
        return function(F){
            ...
            var J=G[0],I=document.createElement("div"),H=I;
            if(!a){
                b.appendChild(I)
                }
                I.innerHTML=[G[1],F,G[2]].flatten().join("");
            while(J--){
                H=H.firstChild
                }
...
o.innerHTML="<select><option>s</option></select>";
if(o.firstChild.value!="s"){
    Element.Properties.value={
        set:function(I){
            var l=this.get("tag");
            if(l!="select"){
                return this.setProperty("value",I)
                }
                var F=this.getElements("option");
            for(var G=0;G<F.length;G++){
                var H=F[G],e=H.getAttributeNode("value"),J=(e&&e.specified)?H.value:H.get("text");
                if(J==I){
...
get:function(){
    var F=this,l=F.get("tag");
    if(l!="select"&&l!="option"){
        return this.getProperty("value")
        }
        if(l=="select"&&!(F=F.getSelected()[0])){
        return""
        }
        var e=F.getAttributeNode("value");
    return(e&&e.specified)?F.value:F.get("text")
    }
}
}
o=null;
...
var h=(j.style.opacity!=null),e=(j.style.filter!=null),k=/alpha\(opacity=([\d.]+)\)/i;
    var a=function(m,l){
    m.store("$opacity",l);
    m.style.visibility=l>0||l==null?"visible":"hidden"
    };
    
var f=(h?function(m,l){
    m.style.opacity=l
    }:(e?function(m,l){
    var o=m.style;
    if(!m.currentStyle||!m.currentStyle.hasLayout){
        ...
        l="alpha(opacity="+(l*100).limit(0,100).round()+")"
        }
        var n=o.filter||m.getComputedStyle("filter")||"";
    o.filter=k.test(n)?n.replace(k,l):n+l;
    if(!o.filter){
        o.removeAttribute("filter")
        }
    }:a));
var g=(h?function(m){
    var l=m.style.opacity||m.getComputedStyle("opacity");
    return(l=="")?1:l.toFloat()
    }:(e?function(m){
    var n=(m.style.filter||m.getComputedStyle("filter")),l;
    if(n){
        l=n.match(k)
        }
        return(l==null||n==null)?1:(l[1]/100)
    }:function(m){
    var l=m.retrieve("$opacity");
    if(l==null){
        l=(m.style.visibility=="hidden"?0:1)
        }
        return l
    }));
var b=(j.style.cssFloat==null)?"styleFloat":"cssFloat";
    Element.implement({
    getComputedStyle:function(n){
        if(this.currentStyle){
            return this.currentStyle[n.camelCase()]
            }
            var m=Element.getDocument(this).defaultView,l=m?m.getComputedStyle(this,null):null;
        return(l)?l.getPropertyValue((n==b)?"float":n.hyphenate()):null
        },
    setStyle:function(m,l){
        if(m=="opacity"){
            ...
            m=(m=="float"?b:m).camelCase();
        if(typeOf(l)!="string"){
            var n=(Element.Styles[m]||"@").split(" ");
            l=Array.from(l).map(function(q,o){
                if(!n[o]){
                    return""
                    }
                    return(typeOf(q)=="number")?n[o].replace("@",Math.round(q)):q
                }).join(" ")
            }else{
            if(l==String(Number(l))){
                l=Math.round(l)
                }
            }
        this.style[m]=l;
    if((l==""||l==null)&&c&&this.style.removeAttribute){
        this.style.removeAttribute(m)
        }
        return this
    },
getStyle:function(t){
    if(t=="opacity"){
        ...
        t=(t=="float"?b:t).camelCase();
    var l=this.style[t];
    if(!l||t=="zIndex"){
        l=[];
        for(var r in Element.ShortStyles){
            if(t!=r){
                continue
            }
            for(var q in Element.ShortStyles[r]){
                l.push(this.getStyle(q))
                }
                return l.join(" ")
            }
            l=this.getComputedStyle(t)
        }
        if(l){
        l=String(l);
        var n=l.match(/rgba?\([\d\s,]+\)/);
        if(n){
            l=l.replace(n[0],n[0].rgbToHex())
            }
        }
    if(Browser.opera||(Browser.ie&&isNaN(parseFloat(l)))){
    if((/^(height|width)$/).test(t)){
        var m=(t=="width")?["left","right"]:["top","bottom"],o=0;
        m.each(function(s){
            o+=this.getStyle("border-"+s+"-width").toInt()+this.getStyle("padding-"+s).toInt()
            },this);
        return this["offset"+t.capitalize()]-o+"px"
        }
        if(Browser.opera&&String(l).indexOf("px")!=-1){
        return l
        }
        if((/^border(.+)Width|margin|padding/).test(t)){
        return"0px"
        }
    }
return l
...
["Top","Right","Bottom","Left"].each(function(s){
    ...
    var q="border"+s;
    r.border[q]=m[q]="@px @ rgb(@, @, @)";
    var o=q+"Width",l=q+"Style",n=q+"Color";
    r[q]={};
    
    r.borderWidth[o]=r[q][o]=m[o]="@px";
    r.borderStyle[l]=r[q][l]=m[l]="@";
    r.borderColor[n]=r[q][n]=m[n]="rgb(@, @, @)"
    })
})();
(function(){
...
[Element,Window,Document].invoke("implement",{
    addEvent:function(f,h){
        ...
        j[f].keys.push(h);
    var g=f,b=Element.Events[f],d=h,k=this;
    if(b){
        if(b.onAdd){
...
var j=function(m){
    return{
        base:"focusin",
        remove:function(n,q){
            var r=n.retrieve(b+m+"listeners",{})[q];
            if(r&&r.forms){
                for(var o=r.forms.length;o--;){
                    r.forms[o].removeEvent(m,r.fns[o])
                    }
                }
            },
listen:function(z,t,x,o,v,u){
    var q=(v.get("tag")=="form")?v:o.target.getParent("form");
    if(!q){
        return
    }
    var w=z.retrieve(b+m+"listeners",{}),r=w[u]||{
        forms:[],
        fns:[]
    },n=r.forms,y=r.fns;
    if(n.indexOf(q)!=-1){
...
if(!c){
    ...
    var h=Element.prototype,f=h.addEvent,k=h.removeEvent;
var e=function(m,n){
    return function(t,s,o){
        if(t.indexOf(":relay")==-1){
            return m.call(this,t,s,o)
            }
        ...
        if(q.pseudos[0].key!="relay"){
            ...
            var r=q.tag;
        q.pseudos.slice(1).each(function(u){
            r+=":"+u.key+(u.value?"("+u.value+")":"")
        });
        m.call(this,t,s);
        return n.call(this,r,q.pseudos[0].value,s)
        }
    };

var g={
    addEvent:function(x,s,z){
        var v=this.retrieve("$delegates",{}),t=v[x];
        if(t){
            for(var A in t){
                if(t[A].fn==z&&t[A].match==s){
                    return this
                    }
                }
            }
            var r=x,w=s,q=z,o=a[x]||{};

x=o.base||r;
s=function(D){
    return Slick.match(D,w)
    };
    
var y=Element.Events[r];
if(y&&y.condition){
    var m=s,n=y.condition;
    s=function(E,D){
        return m(E,D)&&n.call(E,D,x)
        }
    }
var B=this,u=String.uniqueID();
var C=o.listen?function(D,E){
    if(!E&&D&&D.target){
        E=D.target
        }
        if(E){
        o.listen(B,s,z,D,E,u)
        }
    }:function(D,E){
    if(!E&&D&&D.target){
        E=D.target
...
v[r]=t;
return f.call(this,x,C,o.capture)
},
removeEvent:function(u,o,v,w){
    var t=this.retrieve("$delegates",{}),r=t[u];
    if(!r){
        return this
        }
        if(w){
        var n=u,y=r[w].delegator,m=a[u]||{};
    ...
    if(v){
        for(q in r){
            x=r[q];
            if(x.match==o&&x.fn==v){
                return g.removeEvent.call(this,u,o,v,q)
                }
            }
        }else{
    for(q in r){
        x=r[q];
        if(x.match==o){
            g.removeEvent.call(this,u,o,x.fn,q)
            }
        }
    }
    return this
...
(function(){
    ...
    h=e=null;
    var m=function(n){
        return l(n,"position")!="static"||a(n)
        };
        
    var j=function(n){
        return m(n)||(/^(?:table|td|th)$/i).test(n.tagName)
        };
        
    Element.implement({
        scrollTo:function(n,o){
            if(a(this)){
                this.getWindow().scrollTo(n,o)
                }else{
                this.scrollLeft=n;
                this.scrollTop=o
                }
...
getOffsetParent:d?function(){
    var n=this;
    if(a(n)||l(n,"position")=="fixed"){
        return null
        }
        var o=(l(n,"position")=="static")?j:m;
...
getOffsets:function(){
    if(this.getBoundingClientRect&&!Browser.Platform.ios){
        var t=this.getBoundingClientRect(),q=document.id(this.getDocument().documentElement),s=q.getScroll(),v=this.getScrolls(),u=(l(this,"position")=="fixed");
        return{
            x:t.left.toInt()+v.x+((u)?0:s.x)-q.clientLeft,
            y:t.top.toInt()+v.y+((u)?0:s.y)-q.clientTop
            }
        }
    var o=this,n={
    x:0,
...
if(a(this)){
    ...
    if(Browser.firefox){
        if(!c(o)){
            ...
            var r=o.parentNode;
        if(r&&l(r,"overflow")!="visible"){
            n.x+=b(r);
            n.y+=g(r)
            }
        }else{
    if(o!=this&&Browser.safari){
        n.x+=b(o);
        n.y+=g(o)
        }
    }
...
getPosition:function(r){
    var s=this.getOffsets(),o=this.getScrolls();
    var n={
        x:s.x-o.x,
        y:s.y-o.y
        };
        
    if(r&&(r=document.id(r))){
        var q=r.getPosition();
        return{
            x:n.x-q.x-b(r),
            y:n.y-q.y-g(r)
...
getCoordinates:function(q){
    if(a(this)){
        ...
        var n=this.getPosition(q),o=this.getSize();
    var r={
        left:n.x,
        top:n.y,
        width:o.x,
...
computePosition:function(n){
    return{
        left:n.x-k(this,"margin-left"),
        top:n.y-k(this,"margin-top")
        }
    },
setPosition:function(n){
    return this.setStyles(this.computePosition(n))
    }
});
...
getScroll:function(){
    var o=this.getWindow(),n=f(this);
    return{
        x:o.pageXOffset||n.scrollLeft,
        y:o.pageYOffset||n.scrollTop
        }
    },
getScrollSize:function(){
    var q=f(this),o=this.getSize(),n=this.getDocument().body;
    return{
        x:Math.max(q.scrollWidth,n.scrollWidth,o.x),
        y:Math.max(q.scrollHeight,n.scrollHeight,o.y)
        }
},
...
function k(n,o){
    return l(n,o).toInt()||0
    }
    function c(n){
    return l(n,"-moz-box-sizing")=="border-box"
    }
    function g(n){
    return k(n,"border-top-width")
    }
    function b(n){
    return k(n,"border-left-width")
    }
    function a(n){
    return(/^(?:body|html)$/i).test(n.tagName)
    }
    function f(n){
    var o=n.getDocument();
...
(function(){
    ...
    step:function(g){
        if(this.options.frameSkip){
            var h=(this.time!=null)?(g-this.time):0,j=h/this.frameInterval;
            this.time=g;
            this.frame+=j
            }else{
            this.frame++
        ...
        if(this.frame<this.frames){
            var k=this.transition(this.frame/this.frames);
            this.set(this.compute(this.from,this.to,k))
            }else{
    ...
    start:function(l,k){
        ...
        var j=this.options.frames,h=this.options.fps,g=this.options.duration;
...
search:function(a){
    ...
    Array.each(document.styleSheets,function(f,e){
        ...
        Array.each(g,function(k,h){
            ...
            Object.each(Element.Styles,function(m,l){
                if(!k.style[l]||Element.ShortStyles[l]){
                    return
                }
                m=String(k.style[l]);
                c[l]=((/^rgb/).test(m))?m.rgbToHex():m
                })
            })
        });
...
(function(){
    ...
    var k=q.data,f=String(q.url),e=q.method.toLowerCase();
        switch(typeOf(k)){
        case"element":
            k=document.id(k).toQueryString();
            break;
        case"object":case"hash":
            k=Object.toQueryString(k)
            }
    ...
    if(a){
        ...
        Object.each(this.headers,function(s,r){
        try{
            o.setRequestHeader(r,s)
            }catch(t){
            this.fireEvent("exception",[r,s])
            }
        },this);
...
(function(j,l){
    var m,f,e=[],c,b,d=l.createElement("div");
    var g=function(){
        clearTimeout(b);
        if(m){
            return
...
String.implement({
    parseQueryString:function(d,a){
        ...
        if(!c.length){
            ...
            c.each(function(j){
            var e=j.indexOf("=")+1,g=e?j.substr(e):"",f=e?j.substr(0,e-1).match(/([^\]\[]+|(\B)(?=\]))/g):[j],h=b;
            if(!f){
                return
            }
            if(a){
...
getDimensions:function(d){
    ...
    var h=function(k,e){
        return(e.computeSize)?k.getComputedSize(e):k.getSize()
        };
        
    var f=this.getParent("body");
    if(f&&this.getStyle("display")=="none"){
        j=this.measure(function(){
            return h(this,d)
            })
        }else{
        if(f){
...
return Object.append(j,(j.x||j.x===0)?{
    width:j.x,
    height:j.y
    }:{
    x:j.width,
...
Object.each(d.planes,function(j,h){
    var l=h.capitalize(),k=this.getStyle(h);
    if(k=="auto"&&!f){
        f=this.getDimensions()
        }
        k=g[h]=(k=="auto")?f[h]:k.toInt();
    e["total"+l]=k;
    j.each(function(n){
        var m=c(n,g);
...
setPositionCoordinates:function(l,g,d){
    var f=l.offset.y,h=l.offset.x,e=(d==document.body)?window.getScroll():d.getPosition(),k=e.y,c=e.x,j=window.getSize();
    switch(l.position.x){
        case"left":
            g.x=c+h;
            break;
        case"right":
            ...
            break;
        default:
            g.x=c+((d==document.body?j.x:d.offsetWidth)/2)+h;
            break
            }
            switch(l.position.y){
        case"top":
            ...
            break;
        case"bottom":
            g.y=k+f+d.offsetHeight;
            break;
        default:
            g.y=k+((d==document.body?j.y:d.offsetHeight)/2)+f;
            break
            }
        },
...
(function(){
    ...
    calculateScroll:function(g,f){
        var d=this.element,b=d.getScrollSize(),h=d.getScroll(),k=d.getSize(),c=this.options.offset,j={
            x:g,
            y:f
        };
        for(var e in j){
    ...
    toElementEdge:function(d,g,e){
        ...
        d=document.id(d);
        var j={},f=d.getPosition(this.element),k=d.getSize(),h=this.element.getScroll(),b=this.element.getSize(),c={
            x:f.x+k.x,
            y:f.y+k.y
            };
...
toElementCenter:function(e,f,h){
    ...
    e=document.id(e);
    var j={},c=e.getPosition(this.element),d=e.getSize(),b=this.element.getScroll(),g=this.element.getSize();
    ["x","y"].each(function(k){
        if(f.contains(k)){
            j[k]=c[k]-(g[k]-d[k])/2
            }
...
calculateLimit:function(){
    var k=this.element,e=this.container,d=document.id(k.getOffsetParent())||document.body,h=e.getCoordinates(d),c={},b={},l={},g={},n={};
    
    ["top","right","bottom","left"].each(function(s){
        c[s]=k.getStyle("margin-"+s).toInt();
        b[s]=k.getStyle("border-"+s).toInt();
        l[s]=e.getStyle("margin-"+s).toInt();
        g[s]=e.getStyle("border-"+s).toInt();
        n[s]=d.getStyle("padding-"+s).toInt()
        },this);
    var f=k.offsetWidth+c.left+c.right,r=k.offsetHeight+c.top+c.bottom,j=0,m=0,q=h.right-g.right-f,a=h.bottom-g.bottom-r;
...
setSelection:function(f){
    ...
    if(g.substr(0,a).toLowerCase()!=this.queryValue.toLowerCase()){
        ...
        if(f){
            var d=h.split(this.options.separatorSplit).filter(function(k){
                return this.test(k)
                },/[^\s,]+/);
...
showChoices:function(){
    ...
    if(d.length>f){
        var k=d[f-1];
        j.overflowY="scroll";
        j.height=k.getCoordinates(this.choices).bottom;
        this.overflown=true
        }
        this.choices.setStyles(j);
    this.fix.show();
    if(this.options.visibleChoices){
        var h=document.getScroll(),l=document.getSize(),g=this.choices.getCoordinates();
        if(g.right>h.x+l.x){
            h.x=g.right-l.x
            }
            if(g.bottom>h.y+l.y){
...
Element.implement({
    ...
    var g=function(m,l){
        var n=new Element("div"),k=c.tags[m];
        if(k){
            n.innerHTML=k[0]+l+k[1];
            k[2].times(function(){
                n=n.firstChild
                })
            }else{
...
var Form=(function(){
    ...
    function g(m){
    return m.checked?m.value:null
    }
    function e(m){
    return m.value
    }
    function j(m){
    return(m.type==="select-one"?k:b)(m)
    }
    function k(n){
    var m=n.selectedIndex;
    return m>=0?f(n.options[m]):null
    }
    function b(q){
    var m,r=q.length;
    if(!r){
...
function a(m,n){
    ...
    function f(m){
    return a(m,"value")?m.value:m.text
    }
    var l={
    input:h,
    inputSelector:g,
...
function c(m){
    m=$(m);
    var n=m.tagName.toLowerCase();
    return l[n](m)
    }
    function d(q){
    var r=$(q).getElementsByTagName("*"),o,m=[];
    for(var n=0;o=r[n];n++){
        m.push(o)
        }
        return m.inject([],function(s,t){
        if(l[t.tagName.toLowerCase()]){
            s.push($(t))
            }
            return s
        })
    ...
    serialize:function(n,v){
        ...
        var u,t,s=false,r=v.submit,o,q;
    q={};
    ...
    return m.inject(q,function(w,x){
        if(!x.disabled&&x.name){
            u=x.name;
            t=c(x);
            if(t!=null&&x.type!="file"&&(x.type!="submit"||(!s&&r!==false&&(!r||u==r)&&(s=true)))){
                w=o(w,u,t)
                }
            }
        return w
...
if(Browser.ie){
    ...
    if(typeof MooTools=="undefined"||v(MooTools.version)<v(e)){
        throw ("jScroll requires the MooTools JavaScript framework >= "+e);
        return
    }
    var n=/jScroll\.js(\?.*)?$/;
    var c=null;
    var t=$$("head script[src]").find(function(A){
        if(c==null){
            c=A
            }
            return A.src.match(n)
        });
    if(t){
        t=t.src.replace(n,"")
        }else{
...
var f=function(C){
    if($(document.body).getStyle("direction").toLowerCase()=="rtl"){
        ...
        C=C.replace(/ltr/g,"#ltr#");
        C=C.replace(/right/g,"left");
        C=C.replace(/rtl/g,"ltr");
        C=C.replace(/#left#/g,"right");
        C=C.replace(/#ltr#/g,"rtl")
        }
        var A=function(){
        var D=/^[\s\n\r]+|[\s\n\r]+$/g;
        return function(E){
    ...
    if(!G){
        ...
        G.setAttribute("media","screen");
        G.setAttribute("id","jScroll.css");
        ...
        G.appendChild(document.createTextNode(D+" {"+H+"}\n"))
        }
        if(Browser.ie&&Browser.version<9&&document.styleSheets&&document.styleSheets.length>0){
        var F=document.styleSheets[0];
        if(typeof(F.addRule)=="object"){
            F.addRule(D,H)
            }
        }
};

C.replace(/[\n\r]/gi,"").split("}").each(function(D){
    D=D.split("{");
    if(D.length<2||A(D[0])==0||A(D[1])==0){
        return
    }
    B(A(D[0]),A(D[1]))
    })
...
var d=function(A){
    ...
    if(!A.container||!A.container.nodeName||A.container.nodeType!=1){
        throw ("Missing scroll container for jScroll!")
        }
        if(A.container.tagName!="DIV"){
        throw ("invalid scroll container for jScroll! Can only be a div")
        }
        A.container._jScroll=A;
    b(A.container);
    if(y(A,"onRenderBefore")===false){
        return
    }
    if(A.rendered){
        return
    ...
    var C=A.container.getChildren();
    C.each(function(D){
        D.dispose()
        });
    A.container.innerHTML="";
    Element.insert(A.container,{
        bottom:'<div class="jScroll"><div class="jScroll-content"></div><div class="jScroll-scroll '+A.options.clsScroll+'"><div class="jScroll-scroll-up"><div class="'+A.options.clsUp+'"></div></div><div class="jScroll-scroll-between '+A.options.clsBetween+'"></div><div class="jScroll-scroll-slider '+A.options.clsSlider+'"><div class="'+A.options.clsSlider+' top"></div><div class="'+A.options.clsSlider+' center"></div><div class="'+A.options.clsSlider+' bottom"></div></div><div class="jScroll-scroll-between '+A.options.clsBetween+'"></div><div class="jScroll-scroll-down"><div class="'+A.options.clsDown+'"></div></div></div></div>'
        });
    A.element=A.container.down(".jScroll");
    A.elementContent=A.container.down(".jScroll-content");
    A.elementScroll=A.container.down(".jScroll-scroll");
    A.elementUp=A.container.down(".jScroll-scroll-up");
    A.elementUpBetween=A.container.down(".jScroll-scroll-between",0);
    A.elementSlider=A.container.down(".jScroll-scroll-slider");
    A.elementSliderTop=A.elementSlider.down(".top");
    A.elementSliderCenter=A.elementSlider.down(".center");
    A.elementSliderBottom=A.elementSlider.down(".bottom");
    A.elementDownBetween=A.container.down(".jScroll-scroll-between",1);
    A.elementDown=A.container.down(".jScroll-scroll-down");
    C.each(function(D){
        Element.insert(A.elementContent,{
            bottom:D
        })
        });
    var B=0;
    A.elementScroll.addEvent("mousedown",function(D){
        A._sliderScroll=true;
        D.stop();
        l(function(){
            if(x(A.elementSlider)<=B&&B<=x(A.elementSlider)+A.elementSlider.getSize().y){
                return
            }
            var E=B-x(A.elementSlider);
            if(E<0){
                A.elementUpBetween.addClass(A.options.clsBetweenClicked);
                A.elementDownBetween.removeClass(A.options.clsBetweenClicked)
                }else{
                A.elementUpBetween.removeClass(A.options.clsBetweenClicked);
                A.elementDownBetween.addClass(A.options.clsBetweenClicked)
                }
                A.scroll((E<0?-1:1)*A.stepLarge)
            },A)
        });
    A.elementUp.addEvent("mousedown",function(D){
        A._sliderScroll=true;
        D.stop();
        l(A.up.pass([A.stepSmall,A],A),A)
    });
    A.elementDown.addEvent("mousedown",function(D){
        A._sliderScroll=true;
        D.stop();
        l(A.down.pass([A.stepSmall],A),A)
        });
    A.elementSlider.addEvent("mousedown",function(D){
        D.stop();
        A._sliderMove=true;
        A._sliderY=D.page.y-parseFloat(A.elementSlider.getStyle("top"))+A.elementUp.getSize().y
        });
    document.addEvent("mousemove",function(E){
        ...
        E.stop();
        var D=(E.page.y-A._sliderY)*100/A.sliderHeight;
        if(y(A,"onScrollSlideBefore",D)===false){
            return
        }
        A.update(D);
        y(A,"onScrollSlideAfter")
        });
    document.addEvent("mouseup",function(D){
        if(A._sliderMove||A._sliderScroll){
            D.stop();
            A._sliderMove=false;
            A._sliderScroll=false;
            z(A);
            A.elementUpBetween.removeClass(A.options.clsBetweenClicked);
            A.elementDownBetween.removeClass(A.options.clsBetweenClicked);
            A.elementDownBetween.removeClass(A.options.clsBetweenClicked)
...
A.element.addEvent("mousewheel",function(D){
    D.stop();
    A.scroll(-D.wheel*(D.alt?A.stepSmall:A.stepLarge))
    });
A.refresh();
y(A,"onRenderAfter")
};
...
var y=function(B,A,D){
    if(typeof B.options[A]!="function"){
        return true
    }
    if(typeof D!="undefined"){
        ...
        if(B.current==D){
            ...
            var F=B.options[A].pass([B,B.current,D])
        }else{
        var F=B.options[A].pass([B])
        }
        try{
        return F()
        }catch(C){
        if(Browser.firefox){
            var E=C.name+" in "+C.fileName+" #"+C.lineNumber+" : "+C.message
            }else{
            if(Browser.ie){
                var E=C.name+" "+C.number+" : "+C.message
                }else{
                if(Browser.chrome||Browser.safari){
                    var E=C.name+" in "+C.sourceURL+" #"+C.line+" : "+C.message
                    }else{
                    var E=JSON.encode(C)
                    }
                }
        }
    Travian.$d(E+" -> function: "+String(B.options[A]));
return
}
};
...
window.jScroll=new Class({
    ...
    stepLarge:10,
    stepSmall:1,
    applyContent:function(A){
        this.elementContent.innerHTML="";
        Element.insert(this.elementContent,A);
        this.refresh();
        this.update();
        return this
    },
    down:function(A){
        if(typeof A=="undefined"){
            A=this.options.scrollSmall
            }
            if(y(this,"onScrollDownBefore",this.current+A)===false){
            return this
            }
            this.scroll(A);
        y(this,"onScrollDownAfter");
        return this
        },
    initialize:function(A){
...
refresh:function(){
    ...
    if(!this.rendered){
        ...
        D=this.elementContent.getSize().y;
    C=parseInt(this.container.getStyle("max-height"));
    if(C>0){
        this.container.setStyles({
            height:D<=C?D:C
            })
    ...
    this.sliderTop=this.elementUp.getSize().y-o(this.elementUp,"tb");
    this.sliderHeight=this.elementScroll.getSize().y-this.elementUp.getSize().y-o(this.elementUp,"tb")-this.elementDown.getSize().y-o(this.elementDown,"tb");
    var B=this.element.getSize().y;
    var E=this.elementContent.getSize().y;
    this.contentHeight=E-B;
    this.stepSmall=B*100/(this.options.lines*E);
    this.stepLarge=this.stepSmall*this.options.lines;
    var A=(this.sliderHeight*B/E);
    if(A<this.elementSliderTop.getSize().y+this.elementSliderBottom.getSize().y){
        A=this.elementSliderTop.getSize().y+this.elementSliderBottom.getSize().y
        }
    ...
    this.elementSliderCenter.setStyles({
        height:(A-this.elementSliderTop.getSize().y-this.elementSliderBottom.getSize().y)
        });
    this.elementContent.setStyles({
        height:"100%"
    });
...
scroll:function(A){
    if(typeof A=="undefined"||A==0||(A<0&&this.current<=0)||(A>0&&this.current>=100)){
        return this
        }
        if(y(this,"onScrollBefore",this.current+A)===false){
        return this
        }
        this.current+=A;
    this.update();
    y(this,"onScrollAfter");
    return this
    },
scrollTo:function(J){
    var H=this;
    ...
    if(typeOf(J)=="element"){
        ...
        D=$(D);
    if(!D||!D.getParents().find(function(K){
        return K==H.elementContent
        })){
        return this
        }
        var C=x(this.elementContent);
    var I=this.elementContent.getSize().y;
    var B=x(D);
    var F=D.getSize().y;
    switch(E){
        case"top":
            G=(B-C)*100/this.contentHeight;
            break;
        case"view":default:
            G=(B-C-this.sliderHeight/2)*100/this.contentHeight;
            break
            }
            if(y(this,"onScrollBefore",G)===false){
        return this
        }
        this.update(G,A);
    y(this,"onScrollAfter");
...
up:function(A){
    if(typeof A=="undefined"){
        ...
        if(y(this,"onScrollUpBefore",this.current-A)===false){
        return this
    }
    this.scroll(-1*A);
    y(this,"onScrollUpAfter");
    return this
    },
update:function(B,A){
    ...
    if(!this.rendered||!this.enabled){
        ...
        this.current=w(this.current);
    y(this,"onUpdateBefore");
    this.elementSlider.setStyles({
...
jScroll.$=function(B){
    ...
    if(!A&&typeof B=="string"){
        ...
        if(A&&typeof A._jScroll!="undefined"){
            A=A._jScroll
            }else{
            if(A&&typeof A._jScroll=="undefined"){
                A=null
...
var q=function(E,G,F){
    var H=0,C,B;
    E=$(E);
    for(var D=0,A=G.length;D<A;D++){
        C=E.getStyle(F[G.charAt(D)]);
        if(C){
            B=parseInt(C,10);
            if(B){
                H+=(B>=0?B:-1*B)
...
var s=function(B){
    ...
    B=$(B);
    var A=0;
    B.getChildren().each(function(E,D){
        if(E.nodeType!=1){
            if(D==0){
                C=E
                }
        ...
        E=$(E);
        if(C){
            A+=E.offsetTop-B.offsetTop;
            C=null
            }
            return A+E.getSize().y+h(E,"tb")
        });
    return A
    };
...
var o=function(B,C,A){
    B=$(B);
    return A&&Browser.ie&&!j?0:(u(B,C)+g(B,C))
    };
...
var h=function(B,A){
    ...
    if(!A){
        return{
            top:parseInt(B.getStyle("margin-top"),10)||0,
            left:parseInt(B.getStyle("margin-left"),10)||0,
            bottom:parseInt(B.getStyle("margin-bottom"),10)||0,
            right:parseInt(B.getStyle("margin-right"),10)||0
            }
        }else{
    return q(B,A,{
        l:"margin-left",
...
var m=function(C){
    ...
    if(E==D||E==D.body){
        var A,B;
        if(Browser.ie&&j){
            A=D.documentElement.scrollLeft||(D.body.scrollLeft||0);
            B=D.documentElement.scrollTop||(D.body.scrollTop||0)
            }else{
            A=window.pageXOffset||(D.body.scrollLeft||0);
            B=window.pageYOffset||(D.body.scrollTop||0)
            }
            return{
            left:A,
            top:B
...
var x=function(A){
    A=$(A);
    var V,R,G,D,S=(document.body||document.documentElement);
    if(A==S){
        return 0
        }
        ...
        var C=0,Q=0;
    V=A;
    var W=A.getStyle("position")=="absolute";
    while(V){
        $(V);
        C+=V.offsetLeft;
        Q+=V.offsetTop;
        if(!W&&V.getStyle("position")=="absolute"){
            W=true
            }
            if(Browser.firefox){
            R=V;
            var B=parseInt(R.getStyle("borderTopWidth"),10)||0;
            var U=parseInt(R.getStyle("borderLeftWidth"),10)||0;
            C+=U;
            Q+=B;
            if(V!=A&&R.getStyle("overflow")!="visible"){
                C+=U;
                Q+=B
                }
            }
    ...
    if((Browser.chrome||Browser.safari)&&W){
    C-=S.offsetLeft;
    Q-=S.offsetTop
    }
    if(Browser.firefox&&!W){
    var T=$(S);
    C+=parseInt(T.getStyle("borderLeftWidth"),10)||0;
    Q+=parseInt(T.getStyle("borderTopWidth"),10)||0
    }
    V=A.parentNode;
while(V&&V!=S){
    if(!Prototype.Browser.Opera||(V.tagName!="TR"&&$(V).getStyle("display")!="inline")){
        C-=V.scrollLeft;
        Q-=V.scrollTop
        }
        V=V.parentNode
...
var f=function(l){
    var k=l?"localStorage":"sessionStorage";
    if(!window[k]){
        return null
        }
        return window[k]
...
var h=function(m,l){
    var k=m.cachingTime;
    if(typeof l.cachingTime!="undefined"&&l.cachingTime!==null){
        k=l.cachingTime
        }
        return l.time!==false&&(new Date()).getTime()-l.time>k
    };
...
updateContent:function(g){
    ...
    if(this.lastText!=f.text||this.lastTitle!=f.title){
        ...
        if(Math.floor(e*this.options.maxWidthInPercent)<h){
            this.elementContainer.setStyles({
                width:Math.floor(e*this.options.maxWidthInPercent)
                })
            }
...
this.content=this.wrapper.down(".content");
    ...
    a.disableForm();
    a.fireEvent("okay",[a,a.content]);
    if(a.options.keepOpen==false){
        a.close()
        }
        if(!a.options.submitMethod){
        b.stop()
        }
    });
...
if(this.buttonOkText){
    ...
    this.buttonCancel=this.wrapper.down(".cancel").addEvent("click",function(b){
...
if(!this.fx){
    ...
    if(a.options.disposeOnClose&&!a.open){
    a.dispose()
    }
});
...
setContent:function(d,b){
    ...
    if(Math.floor(c*this.options.maxWidthInPercent)<a){
        this.elementContainer.setStyles({
...
iPopup:function(a,b){
    ('<iframe class="popup" frameborder="0"  id="Frame" src="manual.php?typ='+b+"&amp;gid="+a+'" width="475" height="500" scrolling="no" border="0" allowTransparency="true"></iframe>').dialog({
    ...
    initialize:function(a){
        ...
        var b=function(){
            ...
            if(c.elementEntries.length!=0){
                ...
                c.elementEntries.find(function(f,e){
                if(f.hasClass(c.options.classActive)){
                    c.currentPage=Math.floor(e/c.options.maxPerPage)+1;
                    return true
                    }
                    return false
                });
...
this.elementEntries.each(function(d,c){
    var e=Math.floor(c/b.options.maxPerPage)+1;
    if(e==b.currentPage){
        d.show()
        }else{
        d.hide()
...
Travian.Game.InputCoordinates=(function(){
    Element.inject=Element.inject.wrap(function(l,h,k,j){
        e(Travian.Game.InputCoordinates,h);
        return l(h,k,j)
        });
    Element.prototype.inject=Element.prototype.inject.wrap(function(k,j,h){
        e(Travian.Game.InputCoordinates,this);
        return k(j,h)
        });
    Element.insert=Element.insert.wrap(function(k,h,j){
        return e(Travian.Game.InputCoordinates,k(h,j))
        });
    Element.prototype.insert=Element.prototype.insert.wrap(function(j,h){
        return e(Travian.Game.InputCoordinates,j(h))
        });
    var e=function(j,h){
        var k={
            x:null,
        ...
        $(h).getElements(j.options.selector).each(function(l){
            if(l.hasClass(j.options.classNames.x)){
                k.x=l
                }
                if(l.hasClass(j.options.classNames.y)){
                k.y=l
                }
...
var d=function(j,h){
    var k=parseInt(h.value);
    if(k<j.options.range.min){
        h.value=j.options.range.min;
        k=j.options.range.min
    }else{
        if(k>j.options.range.max){
            h.value=j.options.range.max;
            k=j.options.range.max
            }
        }
    return k
};

var c=function(l,m,k){
    var o=k.value;
    var n=l.options.splitChars.find(function(q){
    ...
    if(j.length<=1){
        ...
        var h=[j.shift(),j.join("")].map(function(q){
        q=f(l,q);
        if(q<l.options.range.min){
            q=l.options.range.min
            }else{
            if(q>l.options.range.max){
                q=l.options.range.max
                }
            }
        return parseInt(q)
        });
...
var f=function(h,j){
    return j.split("").filter(function(l,k){
        return(l=="-"||!parseInt(l).isNaN())
        }).filter(function(l,k){
        return !(k>=1&&l=="-")
        }).join("")
    };
    
var a=function(l,h,j,k){
    if(c(h,j,k)){
        l.stop();
        return
    }
...
var b=function(l,h,k,j){
    if(h.options.passThroughChars[l.code]){
        return
    }
    if(l.control){
        return
    }
    if(h.options.validChars[l.code]=="-"&&k.value.indexOf("-")!=-1&&k.getSelectionStart()!=0){
        l.stop();
        return
    }
    if(h.options.splitChars[l.code]){
        if(k.value.length!=0&&parseInt(k.value).isNaN()==false){
            if(Browser.opera){
                k.value=f(h,k.value)
        ...
        if(!h.options.validChars[l.code]){
            l.stop();
            return
        }
    }
...
var g=function(n,j,l,m,o,h){
    if(j.options.passThroughChars[n.code]){
        return
    }
    if(c(j,l,m)){
        if(Browser.opera){
            m.value=f(j,m.value)
            }(o||Travian.emptyFunction)();
        n.stop();
        return
    }
    if(n.control){
    ...
    n.stop();
    if((m.value.length>=1&&j.options.validChars[n.code]=="-")||(j.options.splitChars[n.code])||(!j.options.validChars[n.code])){
        return
    }
    var k=d(j,m);
    if(k.isNaN()){
    ...
    if((k.sgn()==-1&&j.options.range.min.toString().length==k.toString().length)||(k.sgn()>=0&&j.options.range.max.toString().length==k.toString().length)){
        if(Browser.opera){
            m.value=f(j,m.value)
            }(h||Travian.emptyFunction)();
        return
    }
};
...
Travian.Game.RaidList={
    ...
    addSlot:function(b){
        ...
        window.location.href="build.php?gid=16&tt=99&action=showSlot&lid="+b+"&sort="+a+"&direction="+d
        },
    editSlot:function(b,c){
        var d=$("list"+b);
        var a=d.down("input[name=sort]").value;
        var e=d.down("input[name=direction]").value;
        window.location.href="build.php?gid=16&tt=99&action=showSlot&eid="+c+"&sort="+a+"&direction="+e
        },
...
Travian.Game.Hero.Editor=function(){
            ...
            if(c!=null){
                c.addEvent("click",function(f){
                    d.sendAction("save",function(){
                        $(d.options.elementHeroImage).src=d.options.urlHeroImage.substitute({
                            time:(new Date()).getTime()
                            })
                        });
                    f.stop()
    ...
    showAttribute:function(d){
        ...
        if(Browser.ie6){
            ...
            d.setStyles({
                position:"relative",
                height:c.getSize().y+b.getSize().y
                })
            }
            return this
        },
...
dialog:function(a){
    ...
    delete (a.amount);
    delete (a.calculate);
    a.onOpen=(a.onOpen||Travian.emptyFunction).wrap(function(k,j,l){
        var h=l.down("#amount");
        if(h){
            h.value=c
            }
            if(b){
            var f=l.down(b.selectorDisplayUseValue||".displayUseValue");
            var m=l.down(b.selectorDisplayAfterUse||".displayAfterUse");
            if(!f){
                ...
                if(o.isNaN()||o<0){
                    ...
                    var n=o*b.valuePerItem;
                f.set("html",n);
                m.set("html",b.currentValue+n)
                };
                
            g(h.value);
            h.addEvent("keyup",function(n){
                g(h.value)
            })
            }
            return k(j,l)
    ...
    Travian.ajax({
        ...
        onSuccess:function(h){
            ...
            if(h.heroBodyHash){
                ...
                c.items.each(function(l,k){
                $(l.html_id).dispose()
                });
            c.items=new Array();
            h.items.each(function(l,k){
                c.createAndAddItem(l)
                });
            $$(".inventory").each(function(k){
                k.dispose()
                });
            var j=h.inventorySize;
            if(h.heroData.freePoints>0){
                $$("div.hero_inventory .attribute .setPoint").show()
                }
                for(var f=1,e=null;f<=j;f++){
                e=new Element("div",{
                    id:"inventory_"+f,
                ...
                c.createDivs();
            var g=$("attributes");
            $H(h.heroData).each(function(n,l){
                var m=g.down("."+l);
                if(m!=null){
                    var o=m.down(".current");
                    var q=m.down(".progress .bar");
                    var s=m.down(".points");
                    var k=m.getElements(".tooltip");
                    if(m.hasClass("res")){
                        var r=$("setResource").getElements(".resource label .current");
                        r.each(function(u,t){
                            u.set("html",n["resourceHero"+t])
                            })
                        }
                        if(m.hasClass("tooltip")){
                        k.push(m)
                        }
                        if(o&&o.down(".value")){
                        o=o.down(".value")
                        }
                        if(typeof n.current!="undefined"&&o){
                        o.set("html",n.current)
                        }
                        if(typeof n.percent!="undefined"&&q){
                        q.setStyles({
                            width:n.percent+"%"
                            });
                        if(typeof n.backgroundColor!="undefined"){
                            q.setStyles({
                                backgroundColor:n.backgroundColor
                                })
                            }
                        }
                    if(typeof n.points!="undefined"&&s){
                    if(s.down("input")!==null){
                        s.down("input").value=n.points
                        }else{
                        s.set("html",n.points)
                        }
                    }
                if(typeof n.tooltip!="undefined"&&k.length){
                k.setTipUnescaped(n.tooltip)
                }
            }
        });
...
if(g.down(".health")){
    ...
    g.down(".health").down(".bar").setStyles({
        width:h.heroData.health.percent+"%"
        })
}
...
if(e!=true&&!this.isInventoryId(d.id)&&((j.item.instant&&j.item.amount==1)||j.item.amount>1)){
    if(this.options.useOneDialogTitleCallbacks[j.item.typeId]){
        c=Object.merge(c,this.options.useOneDialogTitleCallbacks[j.item.typeId](j.item,this.options,c)||{})
        }
        g=true;
    if(j.item.instant){
        if(j.item.amount==1){
...
if(c.text==""){
    ...
    if(c.show){
    c.onOkay=(c.onOkay||Travian.emptyFunction).wrap(function(l,k,m){
        h(k,m);
        return l(k,m)
        });
    c.onCancel=(c.onCancel||Travian.emptyFunction).wrap(function(l,k,m){
        f.moveToDrop(j,j.item.placeElement,true);
        return l(k,m)
        });
    this.dialog(c)
    }
...
Travian.Game.Hero.Properties.PropertyForm=new Class({
    ...
    onDirty:function(b){
        var a=this.elements.saveHeroAttributes.getInput();
        if(b){
            a.removeClass("disabled").disabled=false
            }else{
            a.addClass("disabled").disabled=true
            }
            return this
        },
    onClick:function(a){
    ...
    initialize:function(b){
        ...
        var d=function(l){
            ...
            if(h){
                ...
                f.setSettedPoints(f.getSettedPoints()+k);
            if(k>0){
                j=f.options.elementBtnPlus;
                f.options.elementBtnMinus.removeClass("click")
                }else{
                j=f.options.elementBtnMinus;
        ...
        this.options.elementInput.addEvents({
            change:function(k){
                var j=parseInt(f.options.elementInput.value);
                if(isNaN(j)){
                    j=f.getTotalPoints()
                    }
                    f.setSettedPoints(j-f.options.usedPoints)
                },
            mousewheel:d
        })
        },
...
Travian.Game.Highlight.Renderer.Rectangle=(function(){
    var a=function(f){
        var j=f.getElement().getCoordinates();
        if(f._lastCoordinates&&f._lastCoordinates.left==j.left&&f._lastCoordinates.top==j.top&&f._lastCoordinates.width==j.width&&f._lastCoordinates.height==j.height&&f._lastCoordinates.right==j.right&&f._lastCoordinates.bottom==j.bottom){
            return
        }
        var c=f.getElementLeft();
        var k=f.getElementTopLeft();
        var h=f.getElementTop();
        var d=f.getElementTopRight();
        var l=f.getElementRight();
        ...
        if(Browser.firefox){
            ...
            c.show().setStyles({
            left:j.left-c.getSize().x,
            top:j.top,
            height:j.height
            });
        k.show().setStyles({
            left:j.left-k.getSize().x,
            top:j.top-k.getSize().y
            });
        h.show().setStyles({
            left:j.left,
            top:j.top-h.getSize().y,
            width:j.width
            });
        d.show().setStyles({
            left:j.right,
            top:j.top-d.getSize().y
            });
        l.show().setStyles({
            left:j.right,
            top:j.top,
        ...
        g.show().setStyles({
            left:j.left-g.getSize().x,
            top:j.bottom
            });
        f._lastCoordinates=j
        };
...
Travian.Game.Highlight.Renderer.Image=new Class({
    ...
    validTypes:["div","span","a","img","input","button"],
    activate:function(){
        ...
        b.insert({
            before:this.getElementBackground().setStyles({
                position:"absolute",
                left:b.offsetLeft-this.options.borderSurround,
                right:"auto",
                top:b.offsetTop-this.options.borderSurround,
                width:a.x+2*this.options.borderSurround,
                height:a.y+2*this.options.borderSurround
                }).show().dispose()
            });
        return this
        },
    ...
    onSuccess:function(c){
        if(c.errorMessage){
            ...
            if(c.formular){
                ...
                if(c.button){
                $("button").set("html",'<div id="prepareError" class="error"></div>'+c.button+'<div class="clear"></div>')
            }
        }
        return false
    }
...
reloadMarketPlace:function(){
    ...
    Travian.ajax({
        ...
        onSuccess:function(b){
            ...
            var d;
            for(d=1;d<5;d++){
                g=parseInt(b.storage["l"+d]);
                resources["l"+d].value=g;
                var f=$("l"+d);
                var e=f.get("html");
                var c=e.split("/");
                f.set("html",g+"/"+c[1]);
                timer["l"+d].start_res=g
                }
...
setNotEnoughMerchantsError:function(b){
    var d={};
    
    var c=this.getNeededMerchants(b);
    $("merchantsNeededNumber").set("html",c);
    if(c>this.merchantsAvailable){
        d={
            MERCHANTS_NEEDED:c,
            MERCHANTS_AVAILABLE:this.merchantsAvailable
            };
            
        $("prepareError").set("html","{notEnoughMerchants}".translate().substitute(d,/\\?\[([^\[\]]+)\]/g));
        $("note").set("html","");
        $("prepareError").addClass("error");
        $("merchantsNeeded").addClass("error");
        $$(".merchantCapacity").addClass("error");
        $("sumResources").addClass("error");
        $("enabledButton").disabled=1;
        ...
        $("enabledButton").disabled=0;
        $("enabledButton").removeClass("disabled")
        }
    },
...
function rndstring(f,d){
    ...
    var a="";
    for(var c=0;c<f;c++){
        var b=Math.floor((Math.random()+d)*0.5*e.length);
        a+=e.substring(b,b+1)
        }
        return a
    }
...
function qst_alt_timer(){
    ...
    if(b&&b.parentNode.style.display!="none"){
        if(!b.timestamp){
            b.timestamp=Math.round(Date.now/1000)+t_format1(b)
            }else{
            var a=b.timestamp-Math.round(Date.now/1000);
            if(a<0){
                b.parentNode.style.display="none";
                document.getElementById("qst_reshere").style.display="block"
                }else{
                $(b).set("html",t_format2(a))
                }
            }
...
function popupDragable(){
    ...
    if(Browser.ie6&&(a.height<700||a.width<700)){
        $("ce").setStyles({
            position:"absolute"
        });
        is_too_small=true
...
var j=function(o,n,r){
    if(!c.isEventsEnabled()){
        return
    }
    if(n!=null&&r!=null&&c.containerViewSize.x<=n&&c.containerViewSize.y<=r&&n<=c.containerViewSize.right&&r<=c.containerViewSize.bottom&&!o.rightClick&&!b&&f&&!h){
        var q=c.transition.translateToMap({
            x:n-c.containerViewSize.x-c.elementSize.x,
...
$(document).addEvents({
    ...
    mousewheel:function(n){
        ...
        if(c.containerViewSize.x<=n.page.x&&c.containerViewSize.y<=n.page.y&&n.page.x<=c.containerViewSize.right&&n.page.y<=c.containerViewSize.bottom&&n.target==c.containerMover){
            var o=c.transition.translateToMap({
                x:n.page.x-c.containerViewSize.x-c.elementSize.x,
                y:n.page.y-c.containerViewSize.y-c.elementSize.y
                });
            if(n.wheel<0){
                c.zoomOut(o)
                }else{
...
moveUp:function(b){
    ...
    this.container=new Element("div",{
        styles:{
        overflow:"hidden",position:"relative",left:0,top:0,width:"100%",height:"100%",right:0,bottom:0
        }
    }).disableSelection().inject(this.containerRender,"top").set("oncontextmenu","return (false);");
this.elementSize={
x:-this.blockSize.width*this.blockOverflow,y:-this.blockSize.height*this.blockOverflow,width:this.containerSize.width+this.blockSize.width*this.blockOverflow*2,height:this.containerSize.height+this.blockSize.height*this.blockOverflow*2
};

this.parent({
    nodeType:"div"
    }).element.setStyles({
    position:"absolute",left:this.elementSize.x,top:this.elementSize.y,width:this.elementSize.width,height:this.elementSize.height
    }).inject(this.container,"top");
this.containerMover=new Element("div",{
    styles:{
    overflow:"hidden",position:"absolute",left:0,top:0,width:this.containerViewSize.width,height:this.containerViewSize.height,zIndex:100,backgroundColor:Browser.ie?"#FFFFFF":"transparent",opacity:Browser.ie?0.001:1
    }
    ...
    for(var h=0,f=0;h<b;h++){
        for(var j=0;j<c;j++){
            g=Travian.Game.Map.Layer.Block.getCorrectPosition({
                x:j*this.blockSize.width+e.x,
                y:h*this.blockSize.height-e.y,
                width:this.blockSize.width,
                height:this.blockSize.height
                },this).position;
            k=this.transition.translateToMap(g);
            d={
                id:f++,
                version:0
            };
            
            if(this.data.blocks[k.x]&&this.data.blocks[k.x][k.y]&&this.data.blocks[k.x][k.y][k.right]&&this.data.blocks[k.x][k.y][k.right][k.bottom]){
                d=Object.merge(d,this.data.blocks[k.x][k.y][k.right][k.bottom])
                }
...
return new Class({
    ...
    initialize:function(e,g){
        ...
        this.zoomOptions.sizes.each(function(j,h){
            if(typeof j=="number"){
...
translateToMap:function(g,h){
    ...
    if(h.round){
        e={
            x:Math.floor((g.x+j.x-this.positionOrigin.browser.x)/this.pixelPerTile.x)+this.positionOrigin.map.x,
            y:this.positionOrigin.map.y-Math.floor((g.y+f+(j.y-this.positionOrigin.browser.y))/this.pixelPerTile.y)
            }
    }else{
        e={
            x:((g.x+j.x-this.positionOrigin.browser.x)/this.pixelPerTile.x)+this.positionOrigin.map.x-1,
            y:this.positionOrigin.map.y-((g.y+f+(j.y-this.positionOrigin.browser.y))/this.pixelPerTile.y)
            }
        }
    if(g.width){
...
Travian.Game.Map.Updater=(function(){
    ...
    var b=function(g){
        if(g.objects.ajax.getLength()<=0){
            ...
            g.updateWorking(+1);
        var f=[];
        g.objects.ajax.each(function(j){
            var h=j.getRequestData();
            if(h!==false){
                f.push(h)
                }
            });
...
var a=function(h,g){
    ...
    var f={
        ...
        y0:g.position.y+h.options.positionOptions.areaAroundPosition[h.transition.zoomLevel].top,
        x1:g.position.x+h.options.positionOptions.areaAroundPosition[h.transition.zoomLevel].right,
        y1:g.position.y+h.options.positionOptions.areaAroundPosition[h.transition.zoomLevel].bottom
        };
    ...
    if(h.requestObject.position){
        ...
        data:Object.merge({},h.parameters.position,{
            data:Object.merge({},g.position,{
                ...
                ignorePositions:h.dataStore.getPositionsOfData(g.dataStoreType).inject([],function(k,j){
                    if(Travian.Game.Map.isMapPositionInRect(f,j)){
                        k.push(Travian.Game.Map.xy2id(j.x,j.y))
                        }
                        return k
                    })
                })
        ...
        onSuccess:function(j){
            h.updateWorking(-1);
            (g.onSuccess||Travian.emptyFunction)(j)
            },
        onFailure:function(j){
            h.updateWorking(-1);
            (g.onFailure||Travian.emptyFunction)(j)
            }
        })
};
...
var d=function(f){
    ...
    f.objects.images.sort(function(k,j){
        var h=k.getPriority();
        var g=j.getPriority();
        if(h<g){
            return -1
    ...
    f.updateWorking(+1);
    if(j.element.src.replace(c,"")==j.srcUrl){
        g.delay(1)
        }else{
        if(!j.imageLoader){
            j.imageLoader=$(new Image()).addEvent("load",g)
            }
            j.refreshSrcUrl();
        j.imageLoader.src=j.srcUrl
        }
...
setContentDataAndRefresh:function(f){
    var g=this;
    if(f.blocks){
        Object.each(f.blocks,function(j,h){
            Object.each(j,function(k,l){
                Object.each(k,function(n,m){
                    Object.each(n,function(s,q){
                        var o={
                            x:h,
                            y:l,
                            right:m,
                        ...
                        var r=Object.merge({},g.dataStore.get(Travian.Game.Map.DataStore.TYPE_BLOCKS,o,"block")||{},s);
                        g.dataStore.push({
...
Travian.Game.Map.DataStore=(function(){
    var f=0;
    var e=function(g){
        Object.each(g.options.useStorageForType,function(j,h){
            if(j){
...
var c=function(j,m,g){
    var k=g.x;
    var n=g.y;
    var h=typeof g.right!="undefined"?g.right:k;
    var l=typeof g.bottom!="undefined"?g.bottom:n;
    if(!j.data[m]){
        j.data[m]={
            all:$H()
            }
...
if(!j.data[m][k][n][h][l].id){
    f++;
    j.data[m][k][n][h][l].id=f
    }
    j.data[m][k][n][h][l].position=g;
return j.data[m][k][n][h][l]
};

var b=function(j,m,g){
    var k=g.x;
    var n=g.y;
    var h=typeof g.right!="undefined"?g.right:k;
    var l=typeof g.bottom!="undefined"?g.bottom:n;
    if(!j.data[m]){
        ...
        if(d(j,j.data[m][k][n][h][l],m)){
        return null
        }
        return j.data[m][k][n][h][l]
    };
    
var d=function(g,j,h){
    return j.time!==false&&(new Date()).getTime()-j.time>g.cachingTimeForType[h]
    };
...
var a=new Class({
    ...
    getDataForArea:function(k,h,n){
        var l=this;
        var g=[];
        var m=null;
        var j=Object.clone(h);
        if(!this.data[k]||!this.data[k].all){
            return g
            }
            if(j.x>j.right){
            j.right+=this.parentContainer.transition.border.width
            }
            if(j.y>j.bottom){
            j.bottom+=this.parentContainer.transition.border.height
            }
            this.data[k].all.each(function(o){
            var q={
                x:o.position.x,
                y:o.position.y
                };
            ...
            if(j.x>q.x){
                q.x+=l.parentContainer.transition.border.width
                }
                if(j.y>q.y){
                q.y+=l.parentContainer.transition.border.height
                }
                if(d(l,o,k)===false&&j.x<=q.x&&q.x<=j.right&&j.y<=q.y&&q.y<=j.bottom){
                if(n){
                    Object.each(o.data,function(r){
                        g.push(r)
                        })
                    }else{
                    g.push(o.data)
...
getPositionsOfData:function(g){
    ...
    if(!this.data[g]||!this.data[g].all){
        ...
        return this.data[g].all.inject([],function(k,j){
        if(d(h,j,g)===false){
            k.push(j.position)
            }
            return k
...
initialize:function(g,j){
    ...
    Object.each(this.options.clearStorageForType,function(l,k){
        if(l){
            Travian.Storage.clear("mapDataContainer."+k,h.options.persistentStorage)
        }
    });
this.options.useStorageForType=$H(this.options.useStorageForType).inject($H(),function(m,n,k){
    if(n){
        m[k]=true;
        h.data[k]=Travian.Storage.get("mapDataContainer."+k,h.options.persistentStorage)||{};
        
        if(!h.data[k].all){
            h.data[k].all=$H({})
            }else{
            h.data[k].all=$H(h.data[k].all);
            var l=h.data[k].all.getKeys().max();
            if(l>f){
                f=l
                }
            }
...
set:function(g){
    ...
    if(typeof g.time=="undefined"){
        ...
        g=Travian.Game.Map.remapShortParameters(g);
    var j=c(this,g.type,g.position);
    j.data=g.data;
    j.time=g.time;
    this.data[g.type].all[j.id]=j;
    if(g.data.symbols){
        g.data.symbols.each(function(l,k){
            if(!l.dataId){
                l.dataId=l.type+"-"+k
                }
...
var d=function(m){
    if(m.elements.coordinates){
        m.elements.coordinates.x.invoke("dispose");
        m.elements.coordinates.y.invoke("dispose")
        }
        m.elements.coordinates={
        x:[],
        y:[]
    };
    ...
    for(var f=0,g=null,j=null;f<n;f+=l){
        g=(new Element("div",{
            "class":"coordinate zoom"+m.transition.zoomLevel,
            styles:{
                position:"absolute",
                left:f*m.mapContainer.blockSize.width/m.transition.elementsPerBlock.x,
                top:0,
                width:l*m.mapContainer.blockSize.width/m.transition.elementsPerBlock.x,
                height:m.containerSize.height
                }
            })).inject(m.elements.moverX,"bottom");
        g.rulerLeft=f*m.mapContainer.blockSize.width/m.transition.elementsPerBlock.x;
        j=g.getDimensions({
        computeSize:true
    });
    g.setStyles({
        width:j.width-j["padding-left"]-j["padding-right"],
        height:j.height-j["padding-top"]-j["padding-bottom"]
        });
    m.elements.coordinates.x[f]=g
    }
    var k=m.transition.elementsInView.y+m.transition.elementsPerBlock.y*2;
var h=m.steps.y[m.transition.zoomLevel];
for(var f=0,g=null,j=null;f<k;f+=h){
    g=(new Element("div",{
        "class":"coordinate zoom"+m.transition.zoomLevel,
        styles:{
            position:"absolute",
            left:0,
            top:f*m.mapContainer.blockSize.height/m.transition.elementsPerBlock.y,
            width:m.containerSize.width,
            height:h*m.mapContainer.blockSize.height/m.transition.elementsPerBlock.y
            }
        })).inject(m.elements.moverY,"bottom");
    g.rulerTop=f*m.mapContainer.blockSize.height/m.transition.elementsPerBlock.y;
    j=g.getDimensions({
    computeSize:true
});
if(j.height-j["padding-top"]-j["padding-bottom"]>0){
    g.setStyles({
        width:j.width-j["padding-left"]-j["padding-right"],
        height:j.height-j["padding-top"]-j["padding-bottom"]
        })
    ...
    m.elements.coordinates.y[f]=g
}
c(m,true,true)
};

var c=function(j,g,f){
    var h=false;
    do{
        h=false;
        if(j.position.x<-2*j.mapContainer.blockSize.width){
            j.position.x+=1*j.mapContainer.blockSize.width;
            g=true;
            h=true
            }
            if(j.position.x>0){
            ...
            j.position.y+=1*j.mapContainer.blockSize.height;
            f=true;
            h=true
            }
            if(j.position.y>0){
...
j.elements.moverX.setStyles({
    left:j.position.x
    });
j.elements.moverY.setStyles({
    top:j.position.y
    });
if(g&&j.elements.coordinates){
    j.elements.coordinates.x.each(function(m,k){
        if(m){
...
if(f&&j.elements.coordinates){
    j.elements.coordinates.y.each(function(l){
        if(l){
            var k=j.transition.translateToMap({
                x:0,
                y:j.position.y+l.rulerTop-j.mapContainer.elementSize.y
                });
            l.set("html",a(j,k.y))
            }
        })
...
Travian.Game.Map.MiniMap=(function(){
    ...
    var b=function(k){
    var f=k.transition.translateToMap({
        x:-k.mapContainer.elementSize.x,
        y:-k.mapContainer.elementSize.y
        },false);
    var j=k.transition.translateToMap({
        x:0,
        y:0,
        width:k.mapContainer.containerViewSize.width,
        height:k.mapContainer.containerViewSize.height
        },{
        round:false,
        correct:false
    });
    j.width=j.right-j.x;
    j.height=j.bottom-j.y;
    var h={
        x:k.containerSize.width/k.transition.border.width,
        y:k.containerSize.height/k.transition.border.height
        };
        
    k.position.width=j.width*h.x;
    k.position.height=j.height*h.y;
    k.position.x=f.x*h.x;
    k.position.x+=k.containerSize.width/2;
    k.position.y=-f.y*h.y;
    k.position.y+=k.containerSize.height/2;
    var g={
        x:k.position.x-k.elementSize["border-left-width"],
        y:k.position.y-k.elementSize["border-top-width"]-k.elementSize["border-bottom-width"],
        width:k.position.width+k.elementSize["border-left-width"]+k.elementSize["border-right-width"],
        height:k.position.height+k.elementSize["border-top-width"]+k.elementSize["border-bottom-width"]
        };
    if(g.width>=k.containerSize.width){
        g.x=-1
        }
        if(g.height>=k.containerSize.height){
        g.y=-1
        }
        k.element.setStyles({
        left:g.x,
    ...
    if(g.width>=k.containerSize.width){
        ...
        if(g.x<0){
            g.x+=k.containerSize.width;
            d=true
            }else{
            if(g.x+g.width>k.containerSize.width){
                g.x-=k.containerSize.width;
                d=true
                }
            }
...
if(g.height>=k.containerSize.height){
    ...
    if(g.y<0){
        g.y+=k.containerSize.height;
        d=true
        }else{
        if(g.y+g.height>k.containerSize.height){
            g.y-=k.containerSize.height;
            d=true
            }
        }
}
k.elementHelpers[0].setStyles({
    left:g.x,
    top:g.y,
    width:g.width,
    height:g.height,
...
this.containerSize=this.container.getDimensions({
    computeSize:!(Browser.chrome||Browser.safari)
    });
...
Travian.Game.Map.Toolbar=new Class({
    ...
    render:function(){
        ...
        this.zoomDropDownClick=this.element.down(".dropdown .dropDownImage").addEvent("click",function(d){
            ...
            c.zoomDropDownDataContainer.setStyles({
                height:Browser.opera?"auto":c.zoomDropDownDataContainer._styleBackup.maxHeight
                })
        });
...
Travian.Game.Map.Layer.Block=(function(){
    var b=function(l,k,j){
        if(typeof k.x=="undefined"){
            ...
            k=Travian.Game.Map.remapShortParameters(k);
        if(typeof k.text=="undefined"&&typeof k.title=="undefined"){
            k.text=l.tooltipHtml.substitute(k.position)
            }
            return k
        };
        
    var c=function(r,o){
        var l=Object.clone(o);
        var k=r.transition.getPointOfCenterInView();
        var m=Object.clone(r.mapCoordinates);
        l.x=parseFloat(l.x);
        l.y=parseFloat(l.y);
        k.x=parseFloat(k.x);
        k.y=parseFloat(k.y);
        ...
        m.y=parseFloat(m.y);
        var n={
            x:(r.transition.border.right-Math.abs(l.x)<r.transition.border.right/2),
            y:(r.transition.border.bottom-Math.abs(l.y)<r.transition.border.bottom/2)
            };
            
        var q={
            x:(r.transition.border.right-Math.abs(k.x)<r.transition.border.right/2),
            y:(r.transition.border.bottom-Math.abs(k.y)<r.transition.border.bottom/2)
            };
        var j={
            x:(r.transition.border.right-Math.abs(m.x)<r.transition.border.right/2),
            y:(r.transition.border.bottom-Math.abs(m.y)<r.transition.border.bottom/2)
            };
            
        if((n.x||q.x)&&(l.x.sgn()+k.x.sgn()==0&&l.x.sgn()!=k.x.sgn())){
            l.x+=k.x.sgn()*r.transition.border.width
            }
            if((n.y||q.y)&&(l.y.sgn()+k.y.sgn()==0&&l.y.sgn()!=k.y.sgn())){
            l.y+=k.y.sgn()*r.transition.border.height
            }
            if((j.x||q.x)&&(m.x.sgn()+k.x.sgn()==0&&m.x.sgn()!=k.x.sgn())){
            m.x+=k.x.sgn()*r.transition.border.width
            }
            if((j.y||q.y)&&(m.y.sgn()+k.y.sgn()==0&&m.y.sgn()!=k.y.sgn())){
            m.y+=k.y.sgn()*r.transition.border.height
            }
            return{
            x:(l.x-m.x)*r.transition.pixelPerTile.x,
            y:(r.transition.elementsPerBlock.y-(l.y-m.y)-1)*r.transition.pixelPerTile.y
            }
        };
    
var g=function(r,o,l){
    if(!o.type){
        throw"Missing symbol type for symbol: "+o.dataId;
        return
    }
    var n=r.symbolTypes[o.type];
    if(!n||!n["class"]||!n.visibleInZoom[r.transition.zoomLevel]){
        return
    }
    if(!r.symbols[o.position.x]){
        r.symbols[o.position.x]={}
    }
    if(!r.symbols[o.position.x][o.position.y]){
    r.symbols[o.position.x][o.position.y]=$H({})
}
var m=n.sizes[r.transition.zoomLevel];
var q=c(r,l);
    var k=r.symbols[o.position.x][o.position.y];
    var j=e(r,n,k);
    k[o.dataId]=new n["class"](Object.merge({},n,o,{
    positionOfTile:{
        x:q.x,
        y:q.y
        },
    ...
    position:{
        x:q.x+j.x,
        y:q.y+j.y,
        width:n.sizes[r.transition.zoomLevel].width,
        height:n.sizes[r.transition.zoomLevel].height
        },
    positionDefault:{
        x:q.x+j.x,
        y:q.y+j.y,
...
var f=function(j){
    ...
    j.dataStore.getDataForArea(Travian.Game.Map.DataStore.TYPE_SYMBOL,j.mapCoordinates,true).each(function(k){
        g(j,k,k.position)
        })
    };
...
var h=function(j){
    if(j.symbols){
        Object.each(j.symbols,function(k){
...
var e=function(o,n,k){
    ...
    var m=k.getKeys().reverse().find(function(q){
        return k[q].position.x==k[q].positionDefault.x&&k[q].position.y==k[q].positionDefault.y&&k[q].position.width==k[q].positionDefault.width&&k[q].position.height==k[q].positionDefault.height
    });
    if(m){
...
var a=function(l,j,k){
    ...
    if(typeof k.tiles!="undefined"&&k.tiles.length!=0){
    Object.each(k.tiles,function(m){
        m=b(l,m,j);
        if(m.position.x==j.x&&m.position.y==j.y){
            k.tile=m
            }
            l.dataStore.set({
            position:m.position,
    ...
    if(typeof k.tile=="undefined"){
    k.tile={};
    
    k.tile=b(l,k.tile,j);
    l.dataStore.set({
        position:k.tile.position,
        type:Travian.Game.Map.DataStore.TYPE_TOOLTIP,
        data:k.tile
        })
    }
    if(typeof k.tiles!="undefined"||typeof k.tile=="undefined"){
    l.dataStore.saveDataToStorage()
    }
...
l.mapContainer.containerMover.setTitle({
    unescaped:true,
    title:k.tile.title,
    text:k.tile.text
    });
l.mapContainer.contextMenu.update()
};
...
return new Class({
    ...
    addSymbol:function(j){
        g(this,j,j.position);
        return this
        },
    deleteSymbol:function(j){
        if(!this.symbols||!this.symbols[j.position.x]||!this.symbols[j.position.x][j.position.y]){
            return this
            }
            if(this.symbols[j.position.x][j.position.y][j.dataId]){
            this.symbols[j.position.x][j.position.y][j.dataId].destroy();
            delete (this.symbols[j.position.x][j.position.y][j.dataId])
        }
        return this
        },
    forceUpdateLayer:function(j){
        if(this.layers[j]){
            this.layers[j].forceUpdateContent()
            }
            return this
        },
    forceUpdateSymbols:function(k,j){
        if(this.symbols){
            Object.each(this.symbols,function(l){
...
getContentForTooltip:function(j){
    var n=this;
    var k=this.transition.translateToMap(j);
    if(this.symbols&&this.symbols[k.x]&&this.symbols[k.x][k.y]&&this.symbols[k.x][k.y]!=0){
        var o=false;
        var m=this.symbols[k.x][k.y].find(function(q){
            o=q.getContentForTooltip();
            return o!==false&&q.isPositionInRect({
                x:j.x-n.position.x,
                y:j.y-n.position.y
                })
            });
    ...
    var l=this.dataStore.get(Travian.Game.Map.DataStore.TYPE_TOOLTIP,k);
    if(l!=null&&(l.text!=undefined||l.title!=undefined)){
    l={
        text:l.text,
        title:l.title
        }
    ...
    l={
        title:"",
        text:this.tooltipHtml.translate(k)
        };
        
    this.requestDataForPosition(k)
    }
    return l
},
getData:function(){
...
move:function(k){
    if(k.x==0&&k.y==0){
        ...
        this.position.x+=k.x;
    this.position.y-=k.y;
    var j=Travian.Game.Map.Layer.Block.getCorrectPosition(this.position,this.mapContainer);
    this.position=j.position;
    this.mapCoordinates=this.transition.translateToMap(this.position);
    this.update(j.updateInnerContent);
    return this
    },
...
render:function(){
    ...
    this.mapCoordinates=this.transition.registerCallbackOnZoom(function(){
        k.mapCoordinates=k.transition.translateToMap(k.position);
        k.update(true)
        }).translateToMap(this.position);
    this.mapContainer.layers.each(function(m,l){
        if(!m["class"]){
            return
        }
        var n={};
...
requestDataForPosition:function(j){
    var k=this;
...
updateContent:function(j){
    this.parent();
    Object.each(this.layers,function(k){
        k.updateContent(j)
        });
    if(j){
        h(this);
...
updateSymbolData:function(j){
    if(!this.symbols||!this.symbols[j.position.x]||!this.symbols[j.position.x][j.position.y]){
        return this
        }
        if(this.symbols[j.position.x][j.position.y][j.dataId]){
        this.symbols[j.position.x][j.position.y][j.dataId].updateData(j)
    }
    return this
    }
})
...
this.dialogInstance=this.dialog.html.substitute({
    ...
    onOpen:function(d,e){
        ...
        var c=(new Travian.Game.ColorPicker(e.down(".select"),{
            ...
            b.colorsArray.find(function(h,j){
                if(h==f){
                    b.color=j
                    }
                })
...
this.dialogInstance=this.dialog.html.substitute({
    ...
    onOpen:function(d,e){
        ...
        var c=(new Travian.Game.ImagePicker(e.down(".select"),{
            ...
            b.imagesArray.find(function(j,h){
                if(j==g){
                    b.index=h+1
                    }
                })
...
Travian.Game.Map.Options.Default.keyboard={
    37:"moveLeft",
    65:"moveLeft",
    100:!Browser.opera?"moveLeft":false,
    52:Browser.opera?"moveLeft":false,
    39:"moveRight",
    68:"moveRight",
    102:!Browser.opera?"moveRight":false,
    54:Browser.opera?"moveRight":false,
    38:"moveUp",
    87:"moveUp",
    104:!Browser.opera?"moveUp":false,
    56:Browser.opera?"moveUp":false,
    40:"moveDown",
    83:"moveDown",
    98:!Browser.opera?"moveDown":false,
    50:Browser.opera?"moveDown":false,
    61:"zoomIn",
    107:!Browser.opera?"zoomIn":false,
    43:Browser.opera?"zoomIn":false,
    109:"zoomOut",
    45:Browser.opera?"zoomOut":false,
    103:!Browser.opera?"moveLeftUp":false,
    55:Browser.opera?"moveLeftUp":false,
    97:!Browser.opera?"moveLeftDown":false,
    49:Browser.opera?"moveLeftDown":false,
    105:!Browser.opera?"moveRightUp":false,
    57:Browser.opera?"moveRightUp":false,
    99:!Browser.opera?"moveRightDown":false,
    51:Browser.opera?"moveRightDown":false,
    speed:{
        slow:"control",
        fast:"shift"
    },
